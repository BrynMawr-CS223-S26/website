...
the Buddhabrot using multiple threads. Each thread will compute a subset of rows in the final image. 
...
Generating buddhabrot with size 480x480
  ...
  Y range = [-1.1200,1.1200]
Thread 140583141971712) sub-image block: rows (0, 120)
Thread 140583133579008) sub-image block: rows (120, 240)
Thread 140583125186304) sub-image block: rows (240, 360)
Thread 140583116793600) sub-image block: rows (360, 480)
