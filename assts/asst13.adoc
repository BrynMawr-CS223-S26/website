...
This is an optional assignment for extra credit on your final grade.  Only complete assignments are eligible for extra credits.
...
* (4 points) Image class
** (0.6 points) load/constructors/assignment/destructor/set (memory management)
