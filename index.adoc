...
* Quiz 1: Tuesday, Feb 10, 50 minutes in lab. link:studyguide1.html[Study Guide 1], link:studyguide2.html[Study Guide 2]
* link:assts/asst04.html[Assignment 04]: Due Friday, Feb 13
